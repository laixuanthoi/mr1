...
//----- encoder banh xe-----
#define ENCODER_BANH_TRAI (vs32)((num_over_t1 << 16) | TIM_GetCounter(TIM1)) / 100
#define ENCODER_BANH_PHAI (vs32)((num_over_t2 << 16) | TIM_GetCounter(TIM2)) / 100

//----- 3 lazers------
#define LAZER_PHAI _ADC1_Value[6]
#define LAZER_TRAI _ADC1_Value[5]
#define LAZER_TRUOC _ADC1_Value[4]

//===== BAN TAY =====
#define DIA_CHI_START4 DATA_SPEED[12] = 255
#define ID4 DATA_SPEED[13] = 4
#define MOTOR_BAN_TAY DATA_SPEED[15]
#define MOTOR_BAN_TAY_THUAN DATA_SPEED[14] = 1
#define MOTOR_BAN_TAY_NGHICH DATA_SPEED[14] = 0

//----- bien tro ban tay
#define BIEN_TRO_BAN_TAY _ADC1_Value[2]

//----- motor hut -----
#define MOTOR_HUT TIM5->CCR2

//----- Xi Lanh Nang Bong: Off Tha Ra, On rut zo -----
#define XI_LANH_NANG_BONG_ON GPIO_WriteBit(GPIOB, GPIO_Pin_15, 1)
#define XI_LANH_NANG_BONG_OFF GPIO_WriteBit(GPIOB, GPIO_Pin_15, 0)

//===== MAM XOAY =====
#define DIA_CHI_START5 DATA_SPEED[16] = 255
#define ID5 DATA_SPEED[17] = 5
#define MOTOR_MAM_XOAY DATA_SPEED[19]
#define MOTOR_MAM_XOAY_THUAN DATA_SPEED[18] = 1
#define MOTOR_MAM_XOAY_NGHICH DATA_SPEED[18] = 0

//----- bien tro mam xoay -----
#define BIEN_TRO_MAM_XOAY _ADC1_Value[3]

//===== CANH TAY =====
#define DIA_CHI_START6 DATA_SPEED[20] = 255
#define ID6 DATA_SPEED[21] = 6
#define MOTOR_CANH_TAY_Y DATA_SPEED[23]
#define MOTOR_CANH_TAY_Y_LEN DATA_SPEED[22] = 1
#define MOTOR_CANH_TAY_Y_XUONG DATA_SPEED[22] = 0

#define DIA_CHI_START7 DATA_SPEED[24] = 255
#define ID7 DATA_SPEED[25] = 6
#define MOTOR_CANH_TAY_X DATA_SPEED[27]
#define MOTOR_CANH_TAY_X_RA DATA_SPEED[26] = 1
#define MOTOR_CANH_TAY_X_VAO DATA_SPEED[26] = 0

//----- encoder canh tay ------
#define ENCODER_CANH_TAY_X (vs32)((num_over_t3 << 16) | TIM_GetCounter(TIM3)) / 100
#define ENCODER_CANH_TAY_Y (vs32)((num_over_t5 << 16) | TIM_GetCounter(TIM5)) / 100

//----- cam bien tu-----
#define CAM_BIEN_TU_Y_TREN GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_7)
#define CAM_BIEN_TU_Y_DUOI GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_10)
#define CAM_BIEN_TU_X_VAO GPIO_ReadInputDataBit(GPIOE, GPIO_Pin_12)
...
vs32 get_Encoder_Banh_Trai()
{
	return Chong_Nhieu_ADC(ENCODER_BANH_TRAI);
}

vs32 get_Encoder_Banh_Phai()
{
	return Chong_Nhieu_ADC(ENCODER_BANH_PHAI);
}

vs32 get_Encoder_Tong()
{
	return abs(get_Encoder_Banh_Trai()) + abs(get_Encoder_Banh_Phai());
}
